...
GdkRGBA             color1, color2, color3, color4, color5 ;
...
main (int argc, char **argv)
{
  ...
  gtk_widget_override_background_color (gtk_bin_get_child (GTK_BIN(bminus)), GTK_STATE_FLAG_NORMAL, &color4);
  ...
  gtk_widget_override_background_color (gtk_bin_get_child (GTK_BIN(bplus)), GTK_STATE_FLAG_NORMAL, &color5);
