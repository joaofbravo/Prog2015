...
GdkRGBA  colorRed, colorBlue, colorGreen, colorYellow, colorCyan, colorBurlywood3 ;
  ...
  if (flag_wa)
    {
      ...
      gtk_widget_override_background_color (gtk_bin_get_child (GTK_BIN(widget)), 
					    GTK_STATE_FLAG_NORMAL, &colorYellow);
    }
  else
    {
      gtk_button_set_label (GTK_BUTTON(widget), "Ajuste para DArea");
      gtk_widget_override_background_color (gtk_bin_get_child (GTK_BIN(widget)), 
					    GTK_STATE_FLAG_NORMAL, &colorRed);
    }
...
int main(int argc, char *argv[])
{
  ...
  gdk_rgba_parse (&colorRed, "#FF0000");
  gdk_rgba_parse (&colorBlue, "#0000FF");
  gdk_rgba_parse (&colorGreen, "#00FF00");
  gdk_rgba_parse (&colorYellow, "#FFFF00");
  gdk_rgba_parse (&colorCyan, "#00FFFF");
  gdk_rgba_parse (&colorBurlywood3,"#CDAA7D");
  ...
  //gtk_widget_override_color (frame1, GTK_STATE_FLAG_NORMAL, &colorRed);
  //gtk_widget_override_background_color (frame1, GTK_STATE_NORMAL, &colorBurlywood3);


  GtkWidget *xx = frame1;      // gtk_bin_get_child (GTK_BIN(frame1));
  //gtk_widget_override_background_color (xx, GTK_STATE_NORMAL, &colorBurlywood3);
  gtk_widget_override_color (xx, GTK_STATE_NORMAL, &colorBurlywood3);


  gtk_widget_override_font (frame1, pango_font_description_from_string("Tahoma bold 14"));
  ...
  gtk_frame_set_label_align (GTK_FRAME(frame1), 0.5, 0.0);
  gtk_widget_override_color (frame1, GTK_STATE_FLAG_NORMAL, &colorRed);
  gtk_widget_override_background_color (frame1, GTK_STATE_NORMAL, &colorCyan);
  gtk_widget_override_font (frame1, pango_font_description_from_string("Tahoma bold 14"));
  ...
  gtk_widget_override_font (button1, pango_font_description_from_string("Tahoma bold 11"));
  ...
  gtk_widget_set_size_request (button1, 210, 20);
  gtk_widget_override_font (button1, pango_font_description_from_string("Tahoma bold 11"));
  gtk_widget_override_background_color (gtk_bin_get_child (GTK_BIN(button1)), 
					GTK_STATE_FLAG_NORMAL, &colorYellow);
  gtk_box_pack_end (GTK_BOX(hbox1), button1, FALSE, TRUE, 3);
