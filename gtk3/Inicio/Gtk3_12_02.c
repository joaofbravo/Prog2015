...
main (int argc, char **argv)
{
  ...
  char       str1[32] ;
  GdkRGBA    colorButton, colorScale, colorScaleBack, colorExit ;

  gtk_init (&argc, &argv);
  setlocale (LC_ALL, "pt_PT.UTF-8");
  setlocale (LC_NUMERIC, "en_US.UTF-8");

  gdk_rgba_parse (&colorButton, "#8E2323");
  gdk_rgba_parse (&colorScale, "#0000FF");
  gdk_rgba_parse (&colorScaleBack, "#0000FF");
  gdk_rgba_parse (&colorExit, "#FF0000");
  ...
  scale = cria_scale ();
  gtk_widget_override_color (scale, GTK_STATE_NORMAL, &colorScale);
  gtk_widget_override_font (scale, pango_font_description_from_string ("Tahoma bold 11"));
  ...
  gtk_widget_override_color (label, GTK_STATE_NORMAL, &colorButton);
  ...
  gtk_widget_override_color (cbBox, GTK_STATE_NORMAL, &colorButton);
  gtk_widget_override_font (cbBox, pango_font_description_from_string ("Tahoma bold 11"));
  ...
  gtk_widget_override_color (bt1, GTK_STATE_NORMAL, &colorButton);
  gtk_widget_override_font (bt1, pango_font_description_from_string ("Tahoma bold 11"));
  ...
  gtk_widget_set_size_request (bt1, 100, 15);
  gtk_widget_override_color (bt1, GTK_STATE_NORMAL, &colorExit);
  gtk_widget_override_font (bt1, pango_font_description_from_string ("Tahoma bold 11"));
